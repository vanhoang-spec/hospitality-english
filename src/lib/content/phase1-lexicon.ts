...
const FO_BANK: P1Bank = {
  ...
  states: [
    ...
    { word: "Early", phonetic: "/ˈɜːli/", definition: "Sớm", icon: "🌄" },
  ],
  routines: [
  ...
  problems: [
    ...
    { word: "Delay", phonetic: "/dɪˈleɪ/", definition: "Sự chậm trễ", icon: "⏳" },
    { word: "Mistake", phonetic: "/mɪˈsteɪk/", definition: "Lỗi, sai sót", icon: "⚠️" },
...
const FB_BANK: P1Bank = {
  ...
  states: [
    ...
    { word: "Warm", phonetic: "/wɔːm/", definition: "Ấm", icon: "🌡️" },
  ],
  routines: [
  ...
  problems: [
    { word: "Spill", phonetic: "/spɪl/", definition: "Làm đổ", icon: "💦" },
    ...
    { word: "Complaint", phonetic: "/kəmˈpleɪnt/", definition: "Lời phàn nàn", icon: "😟" },
...
const HK_BANK: P1Bank = {
  ...
  states: [
    ...
    { word: "Fresh air", phonetic: "/freʃ eə/", definition: "Không khí trong lành", icon: "🍃" },
    { word: "Soft", phonetic: "/sɒft/", definition: "Mềm", icon: "☁️" },
    { word: "Neat", phonetic: "/niːt/", definition: "Ngăn nắp", icon: "✅" },
  ],
  routines: [
...
const SW_BANK: P1Bank = {
  ...
  problems: [
    ...
    { word: "Cloudy water", phonetic: "/ˈklaʊdi ˈwɔːtə/", definition: "Nước đục", icon: "🌫️" },
    { word: "No hot water", phonetic: "/nəʊ hɒt ˈwɔːtə/", definition: "Không có nước nóng", icon: "🚿" },
    { word: "Late arrival", phonetic: "/leɪt əˈraɪvl/", definition: "Đến trễ giờ hẹn", icon: "⏰" },
    { word: "Double booking", phonetic: "/ˈdʌbl ˈbʊkɪŋ/", definition: "Trùng lịch hẹn", icon: "⚠️" },
    { word: "Noise", phonetic: "/nɔɪz/", definition: "Tiếng ồn", icon: "🔊" },
  ],
  closing: [
...
const GR_BANK: P1Bank = {
  ...
  states: [
    { word: "Happy", phonetic: "/ˈhæpi/", definition: "Vui vẻ", icon: "😊" },
    ...
    { word: "Private", phonetic: "/ˈpraɪvət/", definition: "Riêng tư", icon: "🔐" },
  ],
  routines: [
  ...
  problems: [
    ...
    { word: "Wrong name", phonetic: "/rɒŋ neɪm/", definition: "Sai tên", icon: "✏️" },
    ...
    { word: "Wrong date", phonetic: "/rɒŋ deɪt/", definition: "Sai ngày", icon: "📅" },
    { word: "Rain", phonetic: "/reɪn/", definition: "Mưa", icon: "🌧️" },
...
const BO_BANK: P1Bank = {
  ...
  states: [
    ...
    { word: "Monthly", phonetic: "/ˈmʌnθli/", definition: "Hằng tháng", icon: "📆" },
    { word: "Weekly", phonetic: "/ˈwiːkli/", definition: "Hằng tuần", icon: "🗓️" },
  ],
  routines: [
  ...
  problems: [
    { word: "Late delivery", phonetic: "/leɪt dɪˈlɪvəri/", definition: "Giao hàng trễ", icon: "⏰" },
    { word: "Wrong amount", phonetic: "/rɒŋ əˈmaʊnt/", definition: "Sai số tiền", icon: "🔢" },
    { word: "Out of stock", phonetic: "/aʊt əv stɒk/", definition: "Hết hàng trong kho", icon: "📭" },
    { word: "No signal", phonetic: "/nəʊ ˈsɪɡnəl/", definition: "Mất tín hiệu", icon: "📵" },
    { word: "Slow computer", phonetic: "/sləʊ kəmˈpjuːtə/", definition: "Máy tính chạy chậm", icon: "🐌" },
    { word: "Lost file", phonetic: "/lɒst faɪl/", definition: "Mất tệp hồ sơ", icon: "🗃️" },
    { word: "Double charge", phonetic: "/ˈdʌbl tʃɑːdʒ/", definition: "Tính tiền hai lần", icon: "⚠️" },
    { word: "No answer", phonetic: "/nəʊ ˈɑːnsə/", definition: "Không ai trả lời", icon: "🔕" },
  ],
  closing: [
