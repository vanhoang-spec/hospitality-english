    ...
    lesson(lx, 15, 1, "First, Then, After That", "Trình tự: đầu tiên, sau đó", {
      ...
      game: [
        game(
          ...
          undefined,
          "Câu thứ ba đúng ngữ pháp và phủ nhận đúng thứ tuần này dạy: quy trình có thứ tự, và thứ tự là lý do nó tồn tại.",
        ),
      ],
    }),
    ...
    lesson(lx, 15, 2, "Polite Instructions", "Hướng dẫn khách lịch sự", {
      ...
      game: [
        game(
          ...
          undefined,
          "Câu thứ ba đúng ngữ pháp nhưng đẩy việc của mình sang cho khách.",
        ),
      ],
    }),
    ...
    lesson(lx, 15, 3, "Keeping the Order Right", "Giữ đúng thứ tự các bước", {
      ...
      game: [
        game(
          ...
          undefined,
          "Câu thứ ba lịch sự và sai: bỏ một bước là bỏ đúng cái bước mà lần sau sẽ thiếu.",
        ),
      ],
    }),
    ...
    lesson(lx, 15, 4, "Explaining the Whole Routine", "Trình bày trọn quy trình", {
      ...
      game: [
        game(
          ...
          undefined,
          "Câu thứ ba đúng ngữ pháp nhưng dạy khách sợ chính quy trình của khách sạn.",
        ),
      ],
    }),
  ];
    ...
    lesson(lx, 16, 1, "Would You Like…?", "Mời khách bằng 'Would you like…?'", {
      ...
      game: [
        game(
          ...
          undefined,
          "Câu thứ ba đúng ngữ pháp và bỏ mặc khách — khách hỏi chính vì muốn được gợi ý.",
        ),
      ],
    }),
    ...
    lesson(lx, 16, 2, "Explaining What Is Included", "Giải thích những gì đã bao gồm", {
      ...
      game: [
        game(
          ...
          undefined,
          "Câu thứ ba đúng ngữ pháp nhưng đẩy một câu hỏi về tiền sang bộ phận khác; khách sẽ phải hỏi hai lần.",
        ),
      ],
    }),
    ...
    lesson(lx, 16, 3, "Offering an Alternative", "Đề xuất phương án thay thế", {
      ...
      game: [
        game(
          ...
          undefined,
          "Câu thứ ba lịch sự nhưng đóng cửa: từ chối mà không kèm phương án là bỏ khách lại giữa chừng.",
        ),
      ],
    }),
    ...
    lesson(lx, 16, 4, "Closing the Offer", "Chốt lời mời", {
      ...
      game: [
        game(
          ...
          undefined,
          "Câu thứ ba đúng ngữ pháp nhưng không nói ai làm và làm lúc nào — khách không biết mình đang chờ gì.",
        ),
      ],
    }),
  ];
    ...
    lesson(lx, 17, 1, "Could I Have…?", "Xin thông tin bằng 'Could I have…?'", {
      ...
      game: [
        game(
          ...
          undefined,
          "Câu thứ ba đúng ngữ pháp nhưng là một mệnh lệnh; xin thông tin của khách thì phải hỏi, không đòi.",
        ),
      ],
    }),
    ...
    lesson(lx, 17, 2, "Reading Information Back", "Đọc lại thông tin để xác nhận", {
      ...
      game: [
        game(
          ...
          undefined,
          "Câu thứ ba đúng ngữ pháp và bỏ mất bước đọc lại — bước duy nhất bắt được lỗi trước khi nó thành sự cố.",
        ),
      ],
    }),
    ...
    lesson(lx, 17, 3, "Spelling & Precision", "Đánh vần & độ chính xác", {
      ...
      game: [
        game(
          ...
          undefined,
          "Câu thứ ba lịch sự và sai: đoán tên khách là cách nhanh nhất để hỏng cả hồ sơ đặt phòng.",
        ),
      ],
    }),
    ...
    lesson(lx, 17, 4, "Recording the Details", "Ghi lại thông tin", {
      ...
      game: [
        game(
          ...
          undefined,
          "Câu thứ ba đúng ngữ pháp nhưng để ngỏ; gom hết câu hỏi vào một lần là phép lịch sự với thời gian của khách.",
        ),
      ],
    }),
  ];
    ...
    lesson(lx, 18, 1, "I Am Preparing It Now", "Đang xử lý giấy tờ", {
      ...
      game: [
        game(
          ...
          undefined,
          "Câu thứ ba đúng ngữ pháp nhưng đổ lỗi cho hệ thống; khách chỉ cần biết bạn đang làm gì lúc này.",
        ),
      ],
    }),
    ...
    lesson(lx, 18, 2, "You Need to Sign Here", "Hướng dẫn khách ký giấy tờ", {
      ...
      game: [
        game(
          ...
          undefined,
          "Câu thứ ba đúng ngữ pháp nhưng bắt khách làm nhiều hơn mức cần; chỉ đúng ô phải điền cũng là một phần của dịch vụ.",
        ),
      ],
    }),
    ...
    lesson(lx, 18, 3, "Money & Charges", "Tiền bạc & các khoản phí", {
      ...
      game: [
        game(
          ...
          "I am not sure, madam.",
          undefined,
          "Câu thứ ba đúng ngữ pháp nhưng bỏ khách lại với một khoản tiền không ai giải thích.",
        ),
      ],
    }),
    ...
    lesson(lx, 18, 4, "Copies & Records", "Bản sao & lưu hồ sơ", {
      ...
      game: [
        game(
          ...
          undefined,
          "Câu thứ ba đúng ngữ pháp và sai: tờ giấy đó là bằng chứng của khách, không phải bản lưu của khách sạn.",
        ),
      ],
    }),
  ];
    ...
    lesson(lx, 19, 1, "You Must / You Must Not", "Bắt buộc & cấm: must / must not", {
      ...
      game: [
        game(
          ...
          undefined,
          "Câu thứ ba lịch sự và sai: cho phép một việc bị cấm là đẩy hậu quả sang ca sau dọn.",
        ),
      ],
    }),
    ...
    lesson(lx, 19, 2, "Safety Warnings", "Cảnh báo an toàn", {
      ...
      game: [
        game(
          ...
          undefined,
          "Câu thứ ba lịch sự và nguy hiểm: thiết bị khẩn cấp bị xê dịch thì lúc cần sẽ không nằm đúng chỗ.",
        ),
      ],
    }),
    ...
    lesson(lx, 19, 3, "House Rules for Guests", "Nội quy dành cho khách", {
      ...
      game: [
        game(
          ...
          undefined,
          "Câu thứ ba đúng ngữ pháp và sai: mở cửa sổ không đổi được quy định phòng cháy, và tiền phạt sẽ về hoá đơn của khách.",
        ),
      ],
    }),
    ...
    lesson(lx, 19, 4, "Valuables & Emergencies", "Đồ giá trị & tình huống khẩn", {
      ...
      game: [
        game(
          ...
          undefined,
          "Câu thứ ba lịch sự và là một lời bảo đảm mà bạn không có quyền đưa ra.",
        ),
      ],
    }),
  ];
    ...
    lesson(lx, 20, 1, "A or B?", "Đưa hai lựa chọn: A hay B?", {
      ...
      game: [
        game(
          ...
          undefined,
          "Câu thứ ba đúng ngữ pháp nhưng quyết thay khách; việc của bạn là đưa hai lựa chọn thật rõ.",
        ),
      ],
    }),
    ...
    lesson(lx, 20, 2, "Making a Recommendation", "Đưa ra lời khuyên", {
      ...
      game: [
        game(
          ...
          undefined,
          "Câu thứ ba đúng ngữ pháp nhưng bỏ lỡ đúng câu hỏi dễ trả lời nhất trong cả ca của bạn.",
        ),
      ],
    }),
    ...
    lesson(lx, 20, 3, "Respecting the Guest's Choice", "Tôn trọng quyết định của khách", {
      ...
      game: [
        game(
          ...
          undefined,
          "Câu thứ ba đúng ngữ pháp nhưng ép khách nghĩ lại; đổi ý là quyền của khách.",
        ),
      ],
    }),
    ...
    lesson(lx, 20, 4, "Confirming the Decision", "Chốt lại lựa chọn", {
      ...
      game: [
        game(
          ...
          undefined,
          "Câu thứ ba đúng ngữ pháp nhưng không nói ai làm và khi nào; chốt xong thì làm ngay.",
        ),
      ],
    }),
  ];
    ...
    lesson(lx, 21, 1, "What I Did Today", "Kể việc đã làm hôm nay", {
      ...
      game: [
        game(
          ...
          undefined,
          "Câu thứ ba đúng ngữ pháp nhưng mơ hồ về chính việc mình đã làm.",
        ),
      ],
    }),
    ...
    lesson(lx, 21, 2, "Reporting Numbers", "Báo cáo số liệu", {
      ...
      game: [
        game(
          ...
          "manager",
          "Câu thứ ba đúng ngữ pháp nhưng không có con số; báo cáo ca sống bằng con số, không bằng cảm giác.",
        ),
      ],
    }),
    ...
    lesson(lx, 21, 3, "Reporting a Problem", "Báo cáo sự cố đã xảy ra", {
      ...
      game: [
        game(
          ...
          "manager",
          "Câu thứ ba đúng ngữ pháp và giấu một sự cố; ca sau sẽ gặp lại nó mà không biết gì.",
        ),
      ],
    }),
    ...
    lesson(lx, 21, 4, "Handing Over the Shift", "Bàn giao ca", {
      ...
      game: [
        game(
          ...
          "colleague",
          "Câu thứ ba đúng ngữ pháp nhưng đẩy việc tra cứu sang người vừa vào ca.",
        ),
      ],
    }),
  ];
    ...
    lesson(lx, 22, 1, "Sequence & Offer Together", "Ghép quy trình với lời mời", {
      ...
      game: [
        game(
          ...
          undefined,
          "Câu thứ ba đúng ngữ pháp nhưng phủ nhận trình tự, thứ đang là nội dung chính của tuần này.",
        ),
      ],
    }),
    ...
    lesson(lx, 22, 2, "Details, Paperwork & Payment", "Ghép hỏi thông tin với giấy tờ", {
      ...
      game: [
        game(
          ...
          undefined,
          "Câu thứ ba đúng ngữ pháp và bỏ mất chữ ký; thiếu chữ ký thì cả tờ giấy không có giá trị.",
        ),
      ],
    }),
    ...
    lesson(lx, 22, 3, "Rules & Choices Together", "Ghép nội quy với tư vấn lựa chọn", {
      ...
      game: [
        game(
          ...
          undefined,
          "Câu thứ ba đúng ngữ pháp nhưng dừng lại ở lời từ chối; từ chối không kèm phương án là từ chối hai lần.",
        ),
      ],
    }),
    ...
    lesson(lx, 22, 4, "Full Shift Report", "Báo cáo trọn ca làm", {
      ...
      game: [
        game(
          ...
          "manager",
          "Câu thứ ba đúng ngữ pháp nhưng từ chối báo cáo; cấp trên hỏi là để biết, không phải để nghe cảm nhận.",
        ),
      ],
    }),
  ];
    ...
    return lesson(lx, 18, 4, "Check-out, Line by Line", "Trả phòng, từng dòng một", {
      ...
      game: [
        game(
          ...
          undefined,
          "Câu thứ ba lịch sự và sai: đoán minibar trống là cách khách sạn mất tiền, và cách khách bị gọi lại sau khi đã ra sân bay.",
        ),
        game(
          ...
          undefined,
          "Câu thứ ba đúng ngữ pháp và đẩy trách nhiệm cho phần mềm; khoản phí nào cũng phải có một người giải thích được.",
        ),
      ],
    });
  },
    ...
    return lesson(lx, 19, 3, "A Room Number Is Not Mine to Give", "Số phòng thì không nói", {
      ...
      game: [
        game(
          ...
          undefined,
          "Câu thứ ba lịch sự và là một sự cố an ninh: xác nhận một vị khách đang ở đây cũng đã là tiết lộ.",
        ),
        game(
          ...
          undefined,
          "Câu thứ ba lịch sự và sai: 'chỉ lần này thôi' là câu mở đầu của gần như mọi sự cố an ninh.",
        ),
      ],
    });
  },
    ...
    lesson(lx, 18, 3, "Reporting a Fault", "Báo hỏng cho kỹ thuật", {
      ...
      game: [
        game(
          ...
          undefined,
          "Câu thứ ba đúng ngữ pháp và giấu sự cố: lau khô một vũng nước không sửa được cái vòi, và ca sau sẽ gặp lại đúng nó.",
        ),
        game(
          ...
          "colleague",
          "Câu thứ ba nghe hợp lý và sai thẩm quyền: đường nước không nằm trong phần việc của buồng phòng, và một mối nối vặn hỏng là một trần nhà ướt ở tầng dưới.",
        ),
      ],
    }),
    ...
    lesson(lx, 18, 4, "Lost and Found", "Đồ khách bỏ quên", {
      ...
      game: [
        game(
          ...
          undefined,
          "Câu thứ ba lịch sự và là một biên bản: trao đồ tại cửa mà không đối chiếu tên là lúc khách sạn không giải trình được nếu người thật đến nhận sau.",
        ),
        game(
          ...
          "colleague",
          "Câu thứ ba nghe có lý và sai quy trình: giá trị món đồ không phải điều bạn được quyền đánh giá.",
        ),
      ],
    }),
    ...
    return lesson(lx, 18, 3, "The Bill, Line by Line", "Hoá đơn, từng dòng một", {
      ...
      game: [
        game(
          ...
          undefined,
          "Câu thứ ba đúng ngữ pháp và sai người: phí phục vụ do nhà hàng tính chứ không phải bếp, và khoản tiền nào cũng phải có người giải thích được.",
        ),
        game(
          ...
          undefined,
          "Câu thứ ba lịch sự và vượt quyền: giảm giá là quyết định của quản lý ca, và người phải rút lời hứa lại là quản lý, trước mặt chính vị khách đó.",
        ),
      ],
    });
  },
      ...
      "Trước buổi trị liệu: áo choàng & khăn phủ",
      {
        ...
        game: [
          game(
            ...
            undefined,
            "Câu thứ ba đúng ngữ pháp và là chỗ phát sinh gần như mọi khiếu nại nhạy cảm của ngành: quyết định ấy thuộc về khách, không thuộc về bạn.",
          ),
          game(
            ...
            undefined,
            "Câu thứ ba lịch sự và sai: kéo dài buổi này là lấy mất giờ của vị khách kế tiếp, và người phải xin lỗi họ là đồng nghiệp của bạn.",
          ),
        ],
      },
    ),
    ...
    return lesson(lx, 20, 1, "A Request You Must Not Take", "Yêu cầu không được nhận", {
      ...
      game: [
        game(
          ...
          undefined,
          "Câu thứ ba lịch sự và là chỗ mọi sự cố spa bắt đầu: 'chỉ lần này thôi' bỏ đi một ranh giới mà bạn không có quyền bỏ.",
        ),
        game(
          ...
          undefined,
          "Câu thứ ba đúng ngữ pháp và biến bạn thành người cùng giữ bí mật. Việc đúng là dừng tay và gọi quản lý.",
        ),
      ],
    });
  },
    ...
    return lesson(lx, 19, 3, "A Room Number Is Not Mine to Give", "Số phòng thì không nói", {
      ...
      game: [
        game(
          ...
          undefined,
          "Câu thứ ba lịch sự và là một sự cố an ninh: người giao hàng không cần số phòng, họ chỉ cần bó hoa tới đúng nơi.",
        ),
        game(
          ...
          undefined,
          "Câu thứ ba lịch sự và vẫn tiết lộ: trả lời có hay không cũng đều là thông tin về một vị khách.",
        ),
      ],
    });
  },
    ...
    lesson(lx, 18, 2, "The Car at Six-Thirty", "Xe đón lúc sáu rưỡi", {
      ...
      game: [
        game(
          ...
          undefined,
          "Câu thứ ba lịch sự và sai: chưa gọi thì chưa có xe, và người đứng chờ ở sảnh lúc sáu giờ là khách.",
        ),
        game(
          ...
          undefined,
          "Câu thứ ba đúng ngữ pháp và bỏ khách lại với nỗi lo; concierge tồn tại để bảo đảm phần mình biết chắc.",
        ),
      ],
    }),
    ...
    lesson(lx, 19, 4, "When the Guest Is Not Happy", "Khi khách không hài lòng", {
      ...
      game: [
        game(
          ...
          undefined,
          "Câu thứ ba đúng ngữ pháp và đổ lỗi cho bếp ngay trước mặt khách; khách không cần biết bếp thiếu người, khách cần một đĩa nóng.",
        ),
        game(
          ...
          undefined,
          "Câu thứ ba lịch sự và vượt quyền: bỏ một món khỏi hoá đơn là quyết định của quản lý ca, không phải của người phục vụ.",
        ),
      ],
    }),
};
