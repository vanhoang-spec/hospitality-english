  ...
  lessons: [
      ...
      game: [
        {
          ...
          options: [
            ...
            {
              text: "Room 812, a guest is not breathing. I need our first aider now, and 115 is already dialled.",
              correct: true,
            },
            {
        ...
        },
        {
          ...
          options: [
            ...
            {
              text: "Room 812, sir. A guest is unresponsive but he is breathing. Does 115 come, or the doctor? The first aider is with him.",
              correct: true,
            },
            {
    ...
    },
    {
      ...
      vocabulary: [
        ...
        {
          word: "Broken glass",
          phonetic: "/ˌbrəʊkən ˈɡlɑːs/",
          definition: "Mối nguy từ mảnh thuỷ tinh vỡ",
          context: "Broken glass is swept up with a brush, never picked up by hand.",
          icon: "🥃",
        },
        {
          word: "Chemical spill",
      ...
      grammar: [
        {
          ...
          polite:
            "I have found a needle in 610, and I have not touched the bag — may I have a sharps box and tongs?",
    ...
    },
    {
      ...
      grammar: [
        ...
        },
        {
          ...
          polite:
            "The fire team will check every room, sir — my job is to reach every door on this floor.",
          rule: "NGUY HIỂM, không phải bất lịch sự. Gõ cửa rồi đi tiếp. Không mở cửa, không tìm người, không quay lại lấy bất cứ thứ gì — trừ chìa khoá tổng vốn đã ở trên người bạn. Và lối thoát hiểm bị chắn là lỗi duy nhất không được để lại cho ca sau: là cái ghế thì dời ngay, nặng hơn thì báo trong phút đó.",
        },
      ],
      speaking: [
        {
      ...
      speaking: [
        {
          ...
          helpTip:
            "Hứa cái mình giữ được: Ở TRÊN TẦNG, không phải ở TRONG PHÒNG. Quy tắc cửa mở của tuần 35 không nghỉ vì bão. 'Torch' /tɔːtʃ/ — cụm /tʃ/ cuối, không phải /k/.",
        },
        {
      ...
      grammar: [
        {
          ...
          polite:
            "This is above the guide, and I propose we send the letter first — the docket and the evidence sheet are attached.",
      ...
      game: [
        {
          ...
          options: [
            ...
            {
              text: "The incident summary has it: thirty degrees on the label, sixty in our own log.",
              correct: true,
            },
            {
      ...
      grammar: [
        {
          ...
          polite:
            "This is major damage, so the guide allows up to two million dong. I propose we pay the full amount.",
        ...
        },
        {
          ...
          polite: "The payment date I propose is the tenth, and it is written on the letter.",
      ...
      speaking: [
        {
          ...
          speakerRole: "manager",
          targetResponse:
            "This is above the guide, madam — four million against his receipt, not the two million the table allows. May I take it up today?",
          helpTip:
            "CẤP TRÊN nói. Với cấp trên thì gọi MỘT lần lúc mở lời rồi thôi — 'chị' hoặc tên chị ấy; đừng gọi 'madam' mỗi câu, đó là từ dành cho KHÁCH. Xác nhận đúng bậc thẩm quyền, rồi đề xuất HỒ SƠ ĐI LÊN. 'Receipt' /rɪˈsiːt/ — chữ p câm, đừng đọc thành 'ri-xép'.",
        },
        {
      ...
      game: [
        {
          ...
          options: [
            ...
            {
              text: "The guide, sir — major damage allows up to ten times the service fee. It is above her line, so it comes to you.",
              correct: true,
            },
            {
      ...
      game: [
        ...
        },
        {
          ...
          options: [
            ...
            {
              text: "On the department device — I took them with the linen supervisor beside me, both dated Tuesday.",
              correct: true,
            },
            {
