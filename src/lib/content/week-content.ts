  ...
  lessons: [
    {
      ...
      grammar: [
        ...
        },
        {
          ...
          rule: "NGUY HIỂM, không phải bất lịch sự. Không di chuyển, không cho uống nước, không lay người — trừ ba ngoại lệ trong bài đọc, và trừ khi tổng đài 115 bảo bạn làm. Ba việc ai cũng làm được là GỌI, DỌN CHỖ và Ở LẠI. Khách KHÔNG THỞ thì có thêm ba việc nữa trong bài đọc — AED, lật nghiêng, ép tim — và không việc nào chờ ai cho phép.",
        },
      ],
      speaking: [
        {
          guestPrompt: "My husband collapsed by the bed — please, do something!",
          targetResponse:
      ...
      game: [
        ...
        },
        {
          ...
          options: [
            ...
            {
              text: "Room 812. A guest is unresponsive but he is breathing. Does 115 come, or the doctor? The first aider is with him.",
              correct: true,
            },
            {
    ...
    },
    {
      ...
      speaking: [
        ...
        },
        {
          ...
          targetResponse:
            "You may not have to go down, madam — the corridor is clear. Please close your door and stay just behind it. I am telephoning now, and then I am coming straight back to this door and staying here.",
          helpTip:
      ...
      game: [
        ...
        },
        {
          ...
          options: [
            ...
            {
              text: "The lifts go out of use in an alarm, madam. May I give you an arm as far as the stairs?",
              correct: true,
            },
            {
      ...
      speaking: [
        {
          ...
          speakerRole: "manager",
          targetResponse:
            "This one is for the Executive Housekeeper to sign. One guest's jacket, shrunk in our wash — and I propose we send the letter first.",
          helpTip:
      ...
      game: [
        {
          ...
          options: [
            ...
            {
              text: "The ceiling is ten times the service fee, sir — two million. His receipt is one million four, so that is what I propose.",
              correct: true,
            },
            {
    ...
    },
    {
      ...
      vocabulary: [
        ...
        },
        {
          ...
          phonetic: "/prɪˌventɪv ˈmeʒə ˌlɪst/",
        ...
        },
        {
          ...
          phonetic: "/ˌhaʊskiːpɪŋ ˈmænɪdʒə ˌkɒntækt/",
      ...
      grammar: [
        ...
        },
        {
          ...
          polite:
            "The linen team was briefed on Thursday, madam, and the follow-up inspection date is the tenth.",
      ...
      game: [
        {
          ...
          options: [
            ...
            {
              text: "One thing on the preventive measure list: the linen supervisor checks every wash temperature.",
              correct: true,
            },
            {
