      ...
      grammar: [
        {
          ...
          polite:
            "Room 812, a guest is unresponsive and he is breathing — send our first aider and the Duty Manager.",
        ...
        },
        {
          ...
          rule: "NGUY HIỂM, không phải bất lịch sự. Không di chuyển, không cho uống nước, không lay người — trừ năm ngoại lệ đánh số trong bài đọc, và trừ khi tổng đài 115 bảo bạn làm. Ba việc ai cũng làm được là GỌI, DỌN CHỖ và Ở LẠI. Khách KHÔNG THỞ thì có thêm ba việc nữa trong bài đọc — AED, ĐƯA XUỐNG SÀN CỨNG, ép tim — và không việc nào chờ ai cho phép. Lật nghiêng KHÔNG BAO GIỜ dành cho người không thở: đó là tư thế của khách còn thở mà không tỉnh.",
        },
      ],
      speaking: [
        {
          ...
          targetResponse:
            "I have called the first aider and the Duty Manager, madam. I must not move him — only the trained person can. I am staying right here.",
          helpTip:
      ...
      game: [
        ...
        },
        {
          ...
          options: [
            ...
            {
              text: "Room 812. A guest is unresponsive but he is breathing. Do we call 115, sir, or the doctor? The first aider is with him.",
              correct: true,
            },
            {
    ...
    },
    {
      ...
      speaking: [
        ...
        },
        {
          ...
          speakerRole: "colleague",
          targetResponse:
            "In 610 — a needle has gone into my hand. I have washed the wound, and I need to see the nurse now.",
          helpTip:
    ...
    },
    {
      ...
      grammar: [
        ...
        },
        {
          ...
          rule: "NGUY HIỂM, không phải bất lịch sự. Trên BỘ ĐÀM hoặc chỗ khách nghe được thì KHÔNG đọc số phòng — chỉ tầng, 'cannot walk', và tình trạng hành lang. Số phòng chỉ đi qua điện thoại tầng hoặc nói trực tiếp với an ninh. Ngược với công thức gọi nội bộ ở bài 1 — cùng với đường 115, đây là chỗ thứ hai không nói số phòng trước, và là chỗ duy nhất không nói số phòng ra chút nào. Gõ cửa rồi đi tiếp. Không mở cửa, không tìm người, không quay lại lấy bất cứ thứ gì — trừ chìa khoá tổng vốn đã ở trên người bạn. Và lối thoát hiểm bị chắn không bao giờ để lại cho ca sau: là cái ghế thì dời ngay, nặng hơn thì báo trong phút đó.",
        },
      ],
      speaking: [
        {
      ...
      speaking: [
        {
          ...
          speakerRole: "manager",
          targetResponse:
            "This one is for the Executive Housekeeper to sign. One guest's jacket, shrunk in our wash, two million on the guide — and I propose we send the letter first.",
          helpTip:
