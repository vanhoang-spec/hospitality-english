  ...
  lessons: [
    {
      ...
      vocabulary: [
        ...
        },
        {
          ...
          context:
            "Call the first aider by name on the phone — but for water or choking, shout for the nearest hands first.",
          icon: "⛑️",
        },
        {
          word: "AED",
          ...
          definition:
            "Máy sốc tim tự động — hỏi Giám sát tầng xem nhà mình có cho người chưa huấn luyện bật máy không; phần lớn là có, và chính máy quyết định có sốc hay không",
        ...
        },
        {
          ...
          definition:
            "Tư thế nằm nghiêng an toàn — khách BẤT TỈNH MÀ CÒN THỞ thì lật nghiêng, đầu vai hông xoay cùng lúc; đó là việc của bạn, không phải chờ ai",
          context:
            "The recovery position is the first aider's — except when a guest is being sick.",
          icon: "🧑‍⚕️",
        },
      ],
      grammar: [
        ...
        },
        {
          ...
          rule: "NGUY HIỂM, không phải bất lịch sự. Không di chuyển, không cho uống nước, không lay người — trừ ba ngoại lệ trong bài đọc, và trừ khi tổng đài 115 bảo bạn làm. Ba việc người chưa được huấn luyện làm được là GỌI, DỌN CHỖ và Ở LẠI — và cả ba đều có ích thật.",
        },
      ],
      speaking: [
        {
      ...
      reading: {
        text: "A GUEST FOUND UNWELL — LOOK FIRST, THEN THE THREE THINGS AN UNTRAINED PERSON CAN DO\n('House' on this page means your hotel.)\nLOOK BEFORE YOU GO IN. From the doorway, three seconds. Water on the floor, a cable, a smell of gas or burning, anybody else in that room. If any of those is there, you do not go in at all — you call from the corridor. A GAS smell is the one exception: no telephone anywhere on that floor. Walk to the stairwell and call from there. Lesson three has it in full. A second person hurt in that room helps nobody.\nCALL. The first aider and the Duty Manager, by name, from the room phone. THEY call the hotel doctor or 115. In most houses you do not call it yourself — but you never wait for permission when a guest is not breathing. Tell the Duty Manager whether the service lift is free, and ask whether somebody is at the gate for the ambulance. Three minutes lost at a lift can be three minutes of a life.\nIf nobody answers within thirty seconds, dial the operator. If the operator does not answer either, you call 115 yourself. A guest who is NOT BREATHING does not wait for an inside line at all: 115 first. No house should ever discipline anyone for calling an ambulance.\nBut 115 is not an inside line, and a room number means nothing to them. On 115 the FIRST thing you say is where the hotel is. Its name and its street address. Then the floor and the room. Then 'a guest is not breathing'. Say the address twice, in Vietnamese if that is faster — nobody on that line needs your English. Learn your own hotel's address by heart this week.\nOnce you are on 115, the controller on that line IS the trained person. If she tells you to move the guest, to tip the head back, or to push on the chest, you do it. Say aloud what you are doing. Her instruction outranks every NEVER on this page. ON AN INSIDE LINE it is the other way round. Room number FIRST, then the situation in one sentence, then whether the guest is BREATHING. A number said first survives a bad line.\nLook at the chest for ten seconds, no longer. A guest in the worst trouble may still make a noise — a slow, loud gasp every few seconds, like a snore. That is NOT breathing. If the gasps are far apart and the guest does not wake, the answer is 'not breathing'. Then say what you saw: 'Room 812, a guest is unresponsive, and he is breathing.' Or: 'Room 812, a guest is not breathing.'\nA guest who does not wake is an emergency even when he is breathing. Not breathing means 115 before anything else. Unresponsive and breathing means the Duty Manager chooses between the doctor and 115. You ask him which, out loud, so the question is on the record.\nIf the guest is NOT BREATHING and your house keeps an AED, you send for it at once. It is built for someone who has never used one, and most houses let anybody switch it on. Ask your Floor Supervisor whether yours does. Then do exactly what the machine says out loud: the MACHINE decides whether to shock, and it refuses when a shock is wrong. But it never goes onto a wet chest. If the guest is lying in water, bring him clear of it first and dry the chest. Nobody touches him when the machine says stand clear.\nIf 115 takes your address and rings off without telling you what to do, that is normal here. It does not mean you wait. A guest who is not breathing is not made worse by hands on his chest. Push hard and fast in the centre of the chest, two pushes a second, and do not stop until somebody takes over.\nAnd a guest who is UNRESPONSIVE BUT BREATHING is rolled onto his side. Head, shoulders and hips together. That keeps his own tongue and his own sick from closing his throat while you wait, and it is yours to do.\nIf 115 or the first aider tells you to push on the chest, you push. You do not stop until somebody takes over from you.\nAnd if you cannot tell whether a guest is breathing, say you cannot tell. That is an observation, not a diagnosis, and it is yours to give.\nCLEAR. Open the door fully and stand the trolley flat against the far wall. The trolley half of the week thirty-five rule gives way here; the door half does not. A stretcher must reach that door without anybody moving your buckets.\nSTAY. Do not leave to fetch anyone — that is what the phone is for. If a companion is in the room, you stay with them too. But ask on that same call for a second person to come to the door. You touch nothing of the guest's: not a wallet, not a phone, not a watch. Two people in that room protect the guest, and they protect you.\nNEVER: move the guest to another room, sit them up, give water, give medicine, or take anything from the guest's own medicine bag.\nA GUEST WHO SAYS DO NOT CALL ANYBODY. You may not lift him and you may not treat him, but the telephone is not his to refuse. Say one sentence: 'I have to tell my manager, sir — that part is not mine to decide. I am staying with you.' Then call, and tell the Duty Manager the guest said no. Write down the hour he said it. A refusal reported is the house's business; a refusal obeyed is yours alone.\nA GUEST WHO IS AWAKE ON THE FLOOR still does not get lifted, and this is the hardest NEVER here, because they will ask you. Say 'I am not allowed to lift you, madam, and I am not going anywhere.' Then a pillow under the head, a blanket over them. Sit on the floor beside them so they are not looking up at anybody, and ask on the phone how long.\nFOUR exceptions here — water, vomit, the guest's own medicine, and the AED. THREE more in lesson two. And one rule above all of them: what 115 or the first aider tells you to do.\nTHE FIRST IS WATER — a guest face down in a BATH or a basin, where you can reach them standing dry. Look at that water before you touch it. If anything electrical is in it or over it — a hairdryer, a shaver, a charger — you touch nothing and nobody. You call from the corridor, and Engineering kills the power before anyone goes in. If the water is clear, open the door and shout once for the nearest colleague. This is water, and you do not do it alone. Pull out the bath plug — the stopper in the water, never an electrical plug — as you shout. Then hold the head above the water. Do not try to lift the whole guest out by yourself.\nA guest in a POOL is never yours: shout for the lifeguard, throw anything that floats, and do not go in.\nTHE SECOND IS VOMIT. If the guest is being sick and cannot clear it, roll the whole body onto its side. Head, shoulders and hips turn together. Keep the mouth lower than the throat. THE THIRD IS THE GUEST'S OWN MEDICINE. A conscious guest reaching for their own inhaler or adrenaline pen may be helped to reach it — you never choose it for them.\nSay nothing to any other guest and nothing in the corridor. You photograph nothing, and you tell nobody: not another floor, not the canteen, not a group chat, not your family. Guest privacy holds after the shift, after the week, and after you leave the house. Afterwards you write what you SAW and what you DID, with times — never what you think was wrong with them.\nAsk your Floor Supervisor to take you off the floor for the rest of that shift. If the house cannot spare you, ask for somebody to work beside you. Nobody finishes a corridor alone after this.\nIf YOU are the trained first aider tonight, you do what you were trained to do and somebody else makes the call. This page is written for the person who is not.\nFive answers differ by house. Who is trained on your floor. Which number reaches them fastest. WHERE the nearest AED is kept. WHETHER you may switch it on. And WHO calls 115. Ask your Floor Supervisor this week, not on the day.",
        questions: [
          {
      ...
      game: [
        ...
        },
        {
          ...
          options: [
            ...
            {
              text: "Bend forward, sir. Five hard blows between the shoulders — I am doing it now.",
              correct: true,
            },
            {
    ...
    },
    {
      ...
      grammar: [
        {
          ...
          rule: "NGUY HIỂM, không phải bất lịch sự. 'Cannot walk' là cụm rút gọn không chủ ngữ — trên bộ đàm người ta nói cụm, không nói câu đủ; nhưng đừng rút gọn với khách. Giọng bình tĩnh, câu ngắn, có HƯỚNG ĐI. Không ai chạy theo tiếng hét; người ta đi theo giọng bình tĩnh nhất trong hành lang — và một giọng bình tĩnh làm được nhiều hơn một giọng nhanh.",
        },
        {
      ...
      speaking: [
        ...
        },
        {
          ...
          targetResponse:
            "You may not have to go down, madam — the corridor is clear. Please close your door while I telephone the Duty Manager. I am not leaving this floor.",
          helpTip:
      ...
      grammar: [
        {
          ...
          polite:
            "This is above what my supervisor may sign. I propose we send the letter first, and the docket and the evidence sheet are attached.",
    ...
    },
    {
      ...
      grammar: [
        {
          ...
          polite:
            "The service fee was two hundred thousand, so the ceiling is two million. His receipt reads one million four — I propose we pay the receipt.",
      ...
      speaking: [
        {
          ...
          helpTip:
            "CẤP TRÊN nói. Với cấp trên vẫn dùng sir/madam bình thường — đó là chuẩn của nhà. Khác với khách ở chỗ: thêm TÊN một lần lúc mở lời nếu làm việc trực tiếp hằng ngày ('Ms Lan'), rồi thôi. Cái phải bỏ là GIỌNG PHỤC VỤ: đừng bê nguyên những câu vỗ về dành cho khách sang. Với cấp trên là con số và nguồn. Xác nhận đúng bậc thẩm quyền, rồi đề xuất HỒ SƠ ĐI LÊN. 'Receipt' /rɪˈsiːt/ — chữ p câm, đừng đọc thành 'ri-xép'.",
        },
        {
      ...
      reading: {
        ...
        questions: [
          ...
          {
            q: "Đồ vải của khách sạn bị hỏng thì ước tính theo giá nào?",
            options: [
              "Giá bán lẻ hiện nay của loại vải đó ở ngoài thị trường",
              "Giá kho — đúng bằng giá khách sạn đã mua vào lúc trước",
              "Giá mà khách nói món đồ đó đáng bao nhiêu tiền",
            ],
            correct: 1,
          },
          {
      ...
      game: [
        {
          prompt:
            "Duty Manager. Two million is above your supervisor's line — where did this come from?",
          speakerRole: "manager",
          options: [
            {
        ...
        },
        {
          ...
          options: [
            ...
            {
              text: "One jacket, shrunk in our wash. Two million on the guide. I am asking for your approval on the letter.",
              correct: true,
            },
            {
