        ...
        questions: [
          {
            ...
            options: [
              "Bóng bay cao su, cánh hoa rắc sàn, và mọi thứ có mùi thơm",
      ...
      vocabulary: [
        {
          word: "Reset",
          phonetic: "/ˈriːset/",
          definition: "Trả phòng về đúng tiêu chuẩn ban đầu",
      ...
      game: [
        ...
        },
        {
          ...
          options: [
            ...
            {
              text: "Good morning, madam. I will set the room back quietly — please tell me what should stay.",
              correct: true,
            },
            {
      ...
      grammar: [
        {
          ...
          polite:
            "I will bring what I have now, madam. However — for the rest, I will ask my supervisor today.",
      ...
      speaking: [
        {
          ...
          targetResponse:
            "I can do towels twice a day, madam. The second bed service is my supervisor's, in exchange for one fixed hour. May I put it forward and come back before six?",
          helpTip:
