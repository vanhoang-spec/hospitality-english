  ...
  lessons: [
    {
      ...
      vocabulary: [
        ...
        },
        {
          ...
          definition:
            "Tư thế nằm nghiêng an toàn — của người đã huấn luyện, TRỪ khi khách đang nôn mà không tự khạc ra được",
          context:
      ...
      grammar: [
        {
          ...
          rule: "NGUY HIỂM, không phải bất lịch sự. Giọng bình tĩnh, câu ngắn, có HƯỚNG ĐI. Không ai chạy theo tiếng hét; người ta đi theo giọng bình tĩnh nhất trong hành lang — và một giọng bình tĩnh làm được nhiều hơn một giọng nhanh.",
        },
        {
      ...
      game: [
        {
          ...
          options: [
            ...
            {
              text: "We treat every alarm as a real one, sir. Please take a moment, then the stairs are just to your left — I will knock again on my way past.",
              correct: true,
            },
            {
  ...
  lessons: [
    {
      ...
      speaking: [
        {
          ...
          speakerRole: "manager",
          targetResponse:
            "For the Executive Housekeeper. One guest's jacket, shrunk in our wash — two million on the guide, and I propose we send the letter first.",
          helpTip:
      ...
      game: [
        ...
        {
          prompt: "The label was already missing when we took it in. What are you asking me for?",
          speakerRole: "manager",
          options: [
            {
      ...
      grammar: [
        {
          ...
          polite:
            "The service fee was two hundred thousand, so the guide allows up to two million. I propose we pay the guide's full two million.",
      ...
      speaking: [
        {
          ...
          helpTip:
            "CẤP TRÊN nói. Với cấp trên thì gọi TÊN, một lần lúc mở lời rồi thôi — 'Ms Lan' trong câu mẫu, thay bằng tên sếp mình khi luyện. Từ xưng hô kiểu khách thì để dành cho khách. Xác nhận đúng bậc thẩm quyền, rồi đề xuất HỒ SƠ ĐI LÊN. 'Receipt' /rɪˈsiːt/ — chữ p câm, đừng đọc thành 'ri-xép'.",
        },
        {
      ...
      game: [
        {
          ...
          options: [
            ...
            {
              text: "The guide, sir — major damage allows up to ten times the service fee, so up to two million. It is above her line.",
              correct: true,
            },
            {
    ...
    },
    {
      ...
      speaking: [
        {
          guestPrompt:
            "Executive Housekeeper. Before I sign this — how do I know it will not happen again?",
          speakerRole: "manager",
          targetResponse:
