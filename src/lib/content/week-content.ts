      ...
      game: [
        ...
        },
        {
          ...
          options: [
            ...
            {
              text: "Room 812, call 115 — guest choking! Bend forward, sir: five blows between the shoulders.",
              correct: true,
            },
            {
    ...
    },
    {
      ...
      speaking: [
        ...
        },
        {
          ...
          targetResponse:
            "You may not have to go down, madam — the corridor is clear. Please close your door while I telephone the Duty Manager. Security will come to this door for you.",
          helpTip:
