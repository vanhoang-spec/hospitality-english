...
const GR_BANK: P4Bank = {
  ...
  tradeoffs: [
    ...
    {
      word: "Ask about lounge access",
      phonetic: "/ˌɑːsk əˈbaʊt ˈlaʊndʒ ˌækses/",
      definition: "Hỏi về quyền vào phòng chờ — hạng thẻ là của loyalty office",
      icon: "🛋️",
    },
    {
      word: "Ask about a return voucher",
      phonetic: "/ˌɑːsk əˈbaʊt ə rɪˈtɜːn ˈvaʊtʃə/",
      definition: "Hỏi về phiếu quay lại — quản lý duyệt",
      icon: "🎟️",
    },
    {
      word: "Put an upgrade to my manager",
      phonetic: "/pʊt ən ˈʌpɡreɪd tə maɪ ˈmænɪdʒə/",
      definition: "Đưa việc nâng hạng lên quản lý — quầy đề xuất, quản lý quyết",
      icon: "⬆️",
    },
    {
      word: "Ask about your tier",
      phonetic: "/ˌɑːsk əˈbaʊt jɔː ˈtɪə/",
      definition: "Hỏi bộ phận khách quen về hạng thẻ — quầy đề xuất, họ quyết",
      icon: "🏅",
    },
    {
      word: "Ask about your points",
      phonetic: "/ˌɑːsk əˈbaʊt jɔː ˈpɔɪnts/",
      definition: "Hỏi bộ phận khách quen về điểm — quầy đề xuất, họ quyết",
      icon: "⭐",
    },
    {
      word: "Ask about the cancellation fee",
      phonetic: "/ˌɑːsk əˈbaʊt ðə ˌkænsəˈleɪʃn fiː/",
      definition: "Hỏi về phí huỷ — miễn phí là việc của quản lý",
      icon: "💸",
    },
    {
    ...
    {
      word: "Put your dinner bill to my manager",
      phonetic: "/pʊt jɔː ˈdɪnə bɪl tə maɪ ˈmænɪdʒə/",
      definition: "Đưa hoá đơn bữa tối lên quản lý",
      icon: "🍽️",
    },
    {
    ...
    {
      word: "Ask for two free nights",
      phonetic: "/ˌɑːsk fə tuː friː ˈnaɪts/",
      definition: "Xin duyệt thêm hai đêm — con số là của quản lý",
      icon: "🌙",
    },
  ],
  emergencies: [
