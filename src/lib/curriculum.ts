...
export const TOPIC_SEEDS: CurriculumWeek[] = [
  ...
  { department_id: "FO", week_number: 2, title_en: "Group & MICE Check-in Management", title_vi: "Quản lý Đoàn Khách Tour & Phái Đoàn Doanh Nghiệp (MICE Groups)", lessons: [
  ...
  { department_id: "FO", week_number: 3, title_en: "Local Tour Booking & Transport Assistance", title_vi: "Trợ Lý Hành Trình (Concierge Desk & Local Tourism)", lessons: [
  ...
  { department_id: "FO", week_number: 4, title_en: "Payment Settlements, Taxes & Currency Exchange", title_vi: "Quy Trình Check-out, Thuế VAT & Đổi Ngoại Tệ", lessons: [
  ...
  { department_id: "FO", week_number: 5, title_en: "Localized Service Recovery", title_vi: "Cứu Vãn Dịch Vụ Sảnh (Front Office Service Recovery)", lessons: [
  ...
  { department_id: "FB", week_number: 6, title_en: "Breakfast Buffet Welcoming & Station Mapping", title_vi: "Điều Phối & Đón Tiếp Tại Nhà Hàng Buffet Sáng", lessons: [
  ...
  { department_id: "FB", week_number: 7, title_en: "Presenting Local Cuisine & Coffee Culture", title_vi: "Quảng Bá Văn Hóa Ẩm Thực Bản Địa (Culinary Storytelling)", lessons: [
  ...
  { department_id: "FB", week_number: 8, title_en: "A La Carte Order Taking & Wine Upselling", title_vi: "Quy Trình Phục Vụ Gọi Món (A La Carte) & Nghệ Thuật Upselling", lessons: [
  ...
  { department_id: "FB", week_number: 9, title_en: "Gastronomic Service Recovery", title_vi: "Xử Lý Sự Cố Tại Phòng Ăn (F&B Service Recovery)", lessons: [
  ...
  { department_id: "HK", week_number: 10, title_en: "Room Service Requests & Extra Amenities", title_vi: "Quy Trình Giao Tiếp Phòng Khách & Phục Vụ Tiện Ích", lessons: [
  ...
  { department_id: "HK", week_number: 11, title_en: "Express Laundry Service & Damage Disputes", title_vi: "Dịch Vụ Giặt Là Cao Cấp & Tranh Chấp Đồ Vải", lessons: [
  ...
  { department_id: "HK", week_number: 12, title_en: "In-Room Safe Box Lockout & Lost & Found", title_vi: "Xử Lý Két Sắt & Quy Trình Thất Lạc Tài Sản (Lost & Found)", lessons: [
  ...
  { department_id: "SW", week_number: 13, title_en: "Spa Treatment Consultation & Package Upselling", title_vi: "Tư Vấn Liệu Trình Spa & Kỹ Thuật Upselling Gói Trị Liệu", lessons: [
  ...
  { department_id: "SW", week_number: 14, title_en: "Pool & Private Cabana Elite Service", title_vi: "Điều Phối Khu Vực Hồ Bơi/Bãi Biển & Cảnh Báo An Toàn", lessons: [
  ...
  { department_id: "GR", week_number: 15, title_en: "VIP & Executive Club Benefits Management", title_vi: "Chăm Sóc Khách Hàng Thượng Lưu (HNWI) Tại Executive Lounge", lessons: [
  ...
  { department_id: "GR", week_number: 16, title_en: "Milestone Surprise Execution", title_vi: "Thiết Kế Trải Nghiệm Bất Ngờ (Milestone Moments)", lessons: [
  ...
  { department_id: "BO", week_number: 17, title_en: "B2B Account Sales & Contract Negotiations", title_vi: "Đàm Phán Hợp Đồng Đại Lý Lữ Hành & Doanh Nghiệp (B2B Account Sales)", lessons: [
  ...
  { department_id: "BO", week_number: 18, title_en: "MICE & Event Proposal Pitching (BEO)", title_vi: "Đấu Thầu Sự Kiện MICE & Ký Kết Văn Bản BEO", lessons: [
  ...
  { department_id: "BO", week_number: 19, title_en: "Digital Marketing, OTA Optimization & Brand Reputation", title_vi: "Tiếp Thị Số, Tối Ưu Kênh OTA & Quản Trị Danh Tiếng", lessons: [
  ...
  { department_id: "BO", week_number: 20, title_en: "HR Interviewing, Cost Control & Inter-departmental Disputes", title_vi: "Quản Trị Nhân Sự, Kiểm Soát Chi Phí & Thu Mua Nội Bộ", lessons: [
